<style>
  ...
  /* Hover Effect */
  .registered-users-table tr:hover {
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td>
              <!-- Edit Button -->
              <button class="action-button edit" onclick="openEditModal(<?= $row['id'] ?>, '<?= htmlspecialchars($row['f_name']) ?>', '<?= htmlspecialchars($row['l_name']) ?>', '<?= htmlspecialchars($row['email']) ?>', '<?= htmlspecialchars($row['phone']) ?>', '<?= htmlspecialchars($row['birthdate']) ?>')">
                Edit
              </button>
            </td>
            <td>
              <!-- Delete Button -->
              <button class="action-button delete" onclick="totalRegisteredUsersDelete('<?= $row['id'] ?>')">
                Delete
              </button>
            </td>
          </tr>
